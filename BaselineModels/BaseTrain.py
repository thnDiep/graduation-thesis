...
class BaseTrain:
    def __init__(self,
        ...
        self.MODEL_PATH = os.path.join(Path(os.path.abspath(os.path.dirname(__file__))).parent, f'Models/{self.DATASET_NAME}/')
        self.RESULT_PATH = os.path.join(Path(os.path.abspath(os.path.dirname(__file__))).parent, f'Results/{self.DATASET_NAME}/')
        ...
        self.model_dir = os.path.join(self.MODEL_PATH,
                                      f'{self.model_kind}-{self.data_train.data_kind}.pkl')

        self.result_dir = os.path.join(self.RESULT_PATH,
                                       f'{self.model_kind}-{self.data_train.data_kind}')
